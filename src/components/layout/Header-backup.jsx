          ...
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+5565935474200" className="hover:text-blue-200 transition-colors">
                  (65) 9354-7420
                </a>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center space-x-3">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-800 to-blue-600 rounded-full flex items-center justify-center text-white">
              <GraduationCap className="h-6 w-6" />
            </div>
            <div>
              <h1 className="text-sm font-bold text-gray-800 dark:text-white">Educandário</h1>
              <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Jardim Aeroporto</p>
            </div>
          </Link>
